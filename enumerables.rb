...
def print_spicy_foods(spicy_foods)
  # your code here
  spicy_foods.map do |food|
    pepper = "🌶" * food[:heat_level]
    puts "#{food[:name]} (#{food[:cuisine]}) | Heat Level: #{pepper}"
  end
end
...
def print_spiciest_foods(spicy_foods)
  ...
  print_foods = filtered_foods.map do |food|
    pepper = "🌶" * food[:heat_level]
    puts "#{food[:name]} (#{food[:cuisine]}) | Heat Level: #{pepper}"
  end
...
def average_heat_level(spicy_foods)
  ...
  average_heat = (heat_levels.sum) / (heat_levels.count)
  return average_heat
end
